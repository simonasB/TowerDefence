...
namespace TowerDefence.Minions.Dragons {
    public class IntermediateDragon : Minion {
        public IntermediateDragon(float speed, int hitPoints, double moveDelayMilis, IMinionDamageControl minionDamageControl = null) : base(speed, hitPoints, moveDelayMilis,
